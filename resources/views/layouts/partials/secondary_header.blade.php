        ...
        <div class=" my-1" id="itemsSecondary">
            <ul class="navbar-nav me-auto flex-wrap flex-row my-2">
                    <li class="mx-1 mx-lg-2">
                        <a href="https://www.facebook.com/IESTHumbertoCauwe" target="_blank" class="bg-white border-radius-circle" style="padding: 5px 10px;">
                            <i class="fab fa-facebook-f fa-sm text-primary"></i>
                        </a>
                    </li>
                    <li class="mx-1 mx-lg-2">
                        <a href="https://www.instagram.com/iest_humbertocauwe/" class="bg-white border-radius-circle" style="padding: 5px 8px;">
                            <i class="fab fa-instagram fa-sm text-primary"></i>
                        </a>
                    </li>
                    <li class="mx-1 mx-lg-2">
                        <a href="#" class="bg-white border-radius-circle" style="padding: 5px 6px;">
