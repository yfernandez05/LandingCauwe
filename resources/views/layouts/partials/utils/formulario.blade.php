<div class="form-banner mdc-elevation--z2">
    <h3 class="title-form-banner text-primary text-center mb-3 mt-2">INSCRÍBETE AQUÍ</h3>
        ...
        <div class="form-group">
            ...
            <div class="form-group col-12">
                ...
                @if(isset($codigoProducto))
                    ...
                    <input type="hidden" name="codprograma" value="{{ $codigoPrograma }}">
                @endif
            </div>
        </div>
        <button class="btn btn-send_banner btn-secondary text-subtitulo btn-form mdc-elevation--z2 shadow font-primary text-white" id="send-form">
            ENVIAR
        </button>
    </form>
</div>
